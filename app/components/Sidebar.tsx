    ...
    <div className="fixed top-0 left-0 h-screen w-64 z-50 flex flex-col justify-between">
      <div>
        <div className="flex items-center p-6">
          <img src="/images/Subtract.svg" alt="Logo" className="w-8 h-8 rounded-full mr-4" />
      ...
      <div className="p-4">
        <button className="w-full py-2 bg-blue-600 text-white rounded-lg font-semibold mb-4">
          Upgrade Now
        </button>
